...
const startIdx = content.indexOf('  // Ekstrak URL video, subtitle, dan qualities dari streamData');
const endIdx = content.indexOf('const currentEpisodeIndex = drama?.video_list?.findIndex(v => v.vid === currentVideoId) ?? -1;');

if (startIdx !== -1 && endIdx !== -1) {
  const replacement = `  // Ekstrak URL video, subtitle, dan qualities dari streamData
