...
import { useInfiniteDramabox2, useDramabox2Detail } from "@/hooks/useDramabox2";
        ...
        <section className="space-y-4">
            ...
            <div ref={loadMoreRef} className="mt-4 py-8 flex flex-col justify-center items-center w-full min-h-[100px]">
                {isFetchingNextPage ? (
                    ...
                    <p className="text-[10px] uppercase tracking-widest text-muted-foreground opacity-50">Akhir dari Katalog DramaBox</p>
                )}
            </div>
        </section>
    );
