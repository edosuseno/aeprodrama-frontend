...
import { useVeloloDetail } from "@/hooks/useVelolo";
...
export default function VeloloDetailPage() {
    const params = useParams<{ id: string }>();
    const id = params.id;
    const router = useRouter();

    const { data, isLoading, error } = useVeloloDetail(id || "");
        ...
        return (
            <div className="min-h-screen pt-24 px-4">
                <UnifiedErrorDisplay
                    ...
                    message="Tidak dapat memuat detail drama dari Velolo. Silakan coba lagi atau kembali ke beranda."
                    onRetry={handleBack}
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="glass rounded-xl p-4">
                                ...
                                <p className="text-muted-foreground leading-relaxed">
                                    {detail.description || "Nikmati drama pendek berkualitas tinggi dari platform Velolo."}
                                </p>
                            </div>
