...
import { useRadreelsDetail } from "@/hooks/useRadreels";
...
export default function RadreelsDetailPage() {
    const params = useParams<{ id: string }>();
    const id = params.id;
    const router = useRouter();

    const { data, isLoading, error } = useRadreelsDetail(id || "");
    const { setPlatform } = usePlatform();

    const handleBack = () => {
        setPlatform("radreels");
        router.push("/");
    };
        ...
        return (
            <div className="min-h-screen pt-24 px-4">
                <UnifiedErrorDisplay
                    ...
                    message="Tidak dapat memuat detail drama dari Radreels. Silakan coba lagi atau kembali ke beranda."
                    onRetry={handleBack}
    ...
    const displayPosterUrl = posterUrl && !posterUrl.includes('wsrv.nl') 
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="glass rounded-xl p-4">
                                ...
                                <p className="text-muted-foreground leading-relaxed">
                                    {detail.description || "Nikmati drama pendek berkualitas tinggi dari platform Radreels."}
                                </p>
                            </div>
