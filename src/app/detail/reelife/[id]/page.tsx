...
import { useReelifeDetail } from "@/hooks/useReelife";
...
export default function ReelifeDetailPage() {
    const params = useParams<{ id: string }>();
    const id = params.id;
    const router = useRouter();

    const { data, isLoading, error } = useReelifeDetail(id || "");
        ...
        return (
            <div className="min-h-screen pt-24 px-4">
                <UnifiedErrorDisplay
                    ...
                    message="Tidak dapat memuat detail drama dari Reelife. Silakan coba lagi atau kembali ke beranda."
                    onRetry={handleBack}
    ...
    const displayPosterUrl = posterUrl && !posterUrl.includes('wsrv.nl') && !posterUrl.includes('reelife.cc')
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-[300px_1fr] gap-8">
                        ...
                        <div className="relative group">
                            ...
                            <div className="absolute inset-0 rounded-2xl bg-gradient-to-t from-background/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity flex items-end justify-center pb-4">
                                <Link
                                    href={`/watch/reelife/${detail.id}?ep=1`}
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="glass rounded-xl p-4">
                                ...
                                <p className="text-muted-foreground leading-relaxed">
                                    {detail.description || "Nikmati drama pendek berkualitas tinggi dari platform Reelife."}
                                </p>
                            </div>
